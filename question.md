...
Câu 5. Dấu không phải là kiểu dữ liệu cơ bản trong Python?
A. `int`
B. `float`
C. `list`
D. `string`
...
Tuy nhiên trong ảnh, đáp án được khoanh là C. Rất có thể đề bị in hoặc scan nhầm toán tử `or` thành `and`.
Chọn C
...
Trong ảnh, các lựa chọn có dấu hiệu bị mờ hoặc in thiếu số `0`, nhưng đáp án được khoanh là A.
Chọn A
